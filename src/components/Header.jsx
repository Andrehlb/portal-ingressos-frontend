    ...
    >
      <div className="flex items-center justify-between gap-4 w-full">
        ...
        <div className="flex items-center gap-4 h-full">
          ...
          <button
            type="button"
            className="ml-4 px-4 py-3 rounded-full bg-blue-600 text-white font-medium hover:bg-blue-700 transition"
        ...
        <div className="flex items-center gap-4 h-full">
          ...
          <button
            type="button"
            className="border border-blue-600 text-blue-600 px-5 py-3 rounded-full font-semibold hover:bg-blue-50 transition"
